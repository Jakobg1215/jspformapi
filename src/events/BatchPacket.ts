...
import type Config from '@jsprismarine/prismarine/dist/config/Config'
...
export default class BatchPacket extends DataPacket {
    ...
    public constructor(Config: Config, buffer?: Buffer, offset?: number) {
        super(buffer, offset);
        this.config = Config;
        this.compressionLevel = this.config.getPacketCompressionLevel();
    }
